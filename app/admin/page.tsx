...
//       let mainImageUrl = templateData.main_image
//       if (mainImageFile) {
...
//       const additionalImageUrls = [...(templateData.images || [])]
//       for (let i = 0; i < additionalImageFiles.length; i++) {
//         const file = additionalImageFiles[i]
//         if (file) {
//           const formData = new FormData()
...
//             },
//           })
//           additionalImageUrls[i] = uploadResponse.data.url
//         }
//       }

//       // Create template with image URLs
...
//       return api.patch(`/templates/${id}`, { enabled })
//     },
//     onSuccess: () => {
//       queryClient.invalidateQueries({ queryKey: ["templates"] })
//       toast.success("The template status has been updated.")
//     },
//     onError: (error: any) => {
//       toast.error('Error saving template: ' + error.message)
//     },
...
//     toggleTemplateMutation.mutate({ id, enabled: !currentStatus })
//   }
...
//     toggleTemplateMutation.isLoading
...
//             <div>
//               <p className="text-sm text-muted-foreground">Total Templates</p>
//               <h3 className="text-2xl font-bold">{analytics.totalTemplates}</h3>
//             </div>
//           </CardContent>
//         </Card>
...
//                           <TableCell>${template.price}</TableCell>
//                           <TableCell>
//                             {analytics.salesByTemplate?.find((s: any) => s.template_id === template.id)?.count || 0}
//                           </TableCell>
//                           <TableCell>
//                             <div className="flex items-center space-x-2">
//                               <Switch
//                                 checked={template.enabled}
//                                 onCheckedChange={() => handleToggleTemplate(template.id, template.enabled)}
//                                 disabled={toggleTemplateMutation.isLoading}
//                               />
//                               <span>{template.enabled ? "Active" : "Disabled"}</span>
//                             </div>
//                           </TableCell>
...
//                   <ResponsiveContainer width="100%" height="100%">
//                     <RechartsBarChart
//                       data={analytics.salesByTemplate || []}
//                       margin={{
//                         top: 20,
//                         right: 30,
//                         left: 20,
...
//             <DialogFooter>
//               <Button type="submit" disabled={createTemplateMutation.isLoading || updateTemplateMutation.isLoading}>
